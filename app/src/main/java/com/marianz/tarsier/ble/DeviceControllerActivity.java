...
public class DeviceControllerActivity extends AppCompatActivity {
    ...
    private ImageView mImgConnectionState;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mImgConnectionState  = (ImageView) findViewById(R.id.connection_image);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (mConnected) {
            ...
            mConnectionState.setTextColor(Color.parseColor("#12a119"));
            //mImgConnectionState.setImageResource(R.drawable.ic_connected);
        } else {
            menu.findItem(R.id.menu_connect).setVisible(true);
            menu.findItem(R.id.menu_disconnect).setVisible(false);
            mConnectionState.setTextColor(Color.parseColor("#ff0000"));
            //mImgConnectionState.setImageResource(R.drawable.ic_disconnected);
        }
        return true;
    }
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                String gattCharName = SampleGattAttributes.lookup(uuid, unknownCharaString);

                currentCharaData.put(LIST_NAME, gattCharName);
